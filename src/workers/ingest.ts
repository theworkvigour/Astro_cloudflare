/**
 * ingest.ts — Standalone Cloudflare Worker for Vectorize ingestion.
 *
 ...
 *
 * Routes:
 *   POST /ingest  — ingest a single page { id, url, title, content }
 *   POST /reindex — re-index from sitemap (calls sitemap endpoint)
 *   GET  /status  — return Vectorize index stats
 */
